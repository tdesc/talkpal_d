...
class _EventDetailPageState extends State<EventDetailPage> {
      ...
      child: new Container(
        ...
        decoration: new BoxDecoration(
          ...
          image: new DecorationImage(
            fit: BoxFit.cover,
            image: new NetworkImage(widget.event.coverUrl),
          ),
        ),
      ),
    );
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Padding(
            ...
            child: new Text(widget.event.description ?? 'default description'),
          ),
          Text(
            'ListViewItem',
            style: new TextStyle(fontSize: 20.0),
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: new AppBar(
        backgroundColor: Colors.black87,
        title: new Text('Meet ${widget.event.name}'),
      ),
      body: new ListView(
